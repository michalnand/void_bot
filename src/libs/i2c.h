...
class I2C_Interface
{
  public:
    virtual void start() { };
    virtual void stop() { };
    virtual unsigned char write(unsigned char b)  {return 0;};
    virtual unsigned char read(unsigned char ack = 0) {return 0; };
    ...
    virtual unsigned char read_reg(unsigned char dev_adr, unsigned char reg_adr)  {return 0; };
    virtual unsigned int read_reg_16bit(unsigned char dev_adr, unsigned char reg_adr)  {return 0; };
